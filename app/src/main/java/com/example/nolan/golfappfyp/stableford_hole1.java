...
public class stableford_hole1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stableford_hole1);

        txtIndex = (EditText) findViewById(R.id.txtIndex);
        txtPar = (EditText) findViewById(R.id.txtPar);
        txthCap = (EditText) findViewById(R.id.txthCap);
        txtGrossScore = (TextView) findViewById(R.id.txtGrossScore);
        ...
        btnNextHole.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(stableford_hole1.this, stableford_hole2.class);
