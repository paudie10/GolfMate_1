...
public class stableford_hole14_practice extends AppCompatActivity {
    ...
    int par, handicap, holeIndex, score, stableford, yards, front9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNextHole.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(stableford_hole14_practice.this, stableford_hole15_practice.class);
                ...
                extras.putString("front9", front9 + "");
