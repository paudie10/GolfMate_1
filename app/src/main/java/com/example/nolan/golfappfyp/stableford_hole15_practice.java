...
public class stableford_hole15_practice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNextHole.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(stableford_hole15_practice.this, stableford_hole16_practice.class);
