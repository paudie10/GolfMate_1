...
public class stableford_hole1_practice extends AppCompatActivity {
    ...
    int par, handicap, holeIndex, score, stableford = 0, yards;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNextHole.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(stableford_hole1_practice.this, stableford_hole2_practice.class);
