...
public class stableford_hole2 extends AppCompatActivity {
    TextView txtStableford_hole2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stableford_hole2);

        txtIndex = (EditText) findViewById(R.id.txtIndex_hole2);
        txtPar = (EditText) findViewById(R.id.txtPar_hole2);
        txthCap = (EditText) findViewById(R.id.txthCap_hole2);
        txtGrossScore = (TextView) findViewById(R.id.txtGrossScore_hole2);
        txtStableford = (TextView) findViewById(R.id.txtStableford_hole2);
        btnNextHole = (Button) findViewById(R.id.btnNextHole_hole2);
        txtYourScore = (EditText) findViewById(R.id.txtYourScore_hole2);
        bundle = new Bundle();
        ...
        btnNextHole.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(stableford_hole2.this, stableford_hole3.class);
