...
public class stableford_hole3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stableford_hole3);

        txtIndex = (EditText) findViewById(R.id.txtIndex_hole3);
        txtPar = (EditText) findViewById(R.id.txtPar_hole3);
        txthCap = (EditText) findViewById(R.id.txthCap_hole3);
        txtGrossScore = (TextView) findViewById(R.id.txtGrossScore_hole3);
        txtStableford = (TextView) findViewById(R.id.txtStableford_hole3);
        btnNextHole = (Button) findViewById(R.id.btnNextHole_hole3);
        txtYourScore = (EditText) findViewById(R.id.txtYourScore_hole3);
        bundle = new Bundle();
        ...
        btnNextHole.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(stableford_hole3.this, stableford_hole4.class);
