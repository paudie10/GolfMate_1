...
public class stableford_hole4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stableford_hole4);

        txtIndex = (EditText) findViewById(R.id.txtIndex_hole4);
        txtPar = (EditText) findViewById(R.id.txtPar_hole4);
        txthCap = (EditText) findViewById(R.id.txthCap_hole4);
        txtGrossScore = (TextView) findViewById(R.id.txtGrossScore_hole4);
        txtStableford = (TextView) findViewById(R.id.txtStableford_hole4);
        btnNextHole = (Button) findViewById(R.id.btnNextHole_hole4);
        txtYourScore = (EditText) findViewById(R.id.txtYourScore_hole4);
        bundle = new Bundle();
        ...
        btnNextHole.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(stableford_hole4.this, stableford_hole5.class);
